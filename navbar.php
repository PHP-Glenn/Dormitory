...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=tenants" class="nav-item nav-tenants"><span class='icon-field'><i class="fa fa-user-friends "></i></span>  Boarders</a>
				...
				<a href="index.php?page=roomaccount" class="nav-item nav-user"><span class='icon-field'><i class="fa fa-user-friends "></i></span> Room Accounts</a>
